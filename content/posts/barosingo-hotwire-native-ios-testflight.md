...
- **120 다산콜센터**: `02-120`으로 문자 전송 가능, 사진 첨부도 가능
...
1. **허위신고 경고**: 신고 버튼 아래에 형사처벌 경고 문구 추가
2. **면책 조항**: "정부 공식 앱이 아니며, 문자 신고 작성을 돕는 편의 도구" 명시
3. **긴급 전화 권고**: 112/119 선택 시 "긴급 상황에는 전화가 더 빠릅니다" 안내 + 전화 연결 버튼
4. **개인정보 최소화**: 회원가입 없이 사용, 위치정보는 전송 후 즉시 파기
5. **개인정보 처리방침**: 별도 페이지로 작성하여 ASC에 등록
